...
- **Every part a shipped style sheet points at travels with it.** Cell formats
  60 and 61 — the twenty-five ROOKIE cells and the twenty-five WAIT LIST cells
  — carry an `xfComplement` indexing into
  `app/templates/rcf/featurePropertyBag.xml`, which resolves to
