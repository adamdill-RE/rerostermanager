...
$tiles = [
    ...
    ['cap' => Capability::LookUpMembers,         'label' => 'Look Up Members',     'route' => 'lookup', 'phase' => '', 'group' => 'administer', 'why' => 'Paste a list of member numbers: where each one stands, when they first appeared, and every RCF about them.'],
